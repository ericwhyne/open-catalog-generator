...
def filter_html():
  ...
  html += "<div class='darpa-header-text'><h1 class='no_space'><span><font color='white'> / </font><a href=\"http://www.darpa.mil/Our_Work/I2O/\"' class='programlink programheader programheader-i2o'>Information Innovation Office (I2O) &nbsp/&nbsp</a><a href=\"catalog_filter.html\"' class='programlink visheader'>Catalog Filter</a></span></h1></div></div>"
