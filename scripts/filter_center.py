...
def filter_header():
  ...
  <link rel="stylesheet" type="text/css" href="css/filter_center.css"/>
...
def filter_html():
  ...
  html += "<div class='darpa-header-text'><h1 class='no_space'><span><font color='white'> / </font><a href=\"http://www.darpa.mil/Our_Work/I2O/\"' class='programlink programheader programheader-i2o'>Information Innovation Office (I2O) &nbsp/&nbsp</a><a href=\"filter_center.html\"' class='programlink visheader'>Data Filter</a></span></h1></div></div>"
  ...
  <div id="tabs" class="table-tabs ui-tabs ui-widget ui-widget-content ui-corner-all">
	<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
		<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="tabs0" aria-labelledby="ui-id-1" aria-selected="true">
			<a id="ui-id-1" class="ui-tabs-anchor" href="#tabs0" role="presentation" tabindex="-1">Filter All Artifacts</a>
		</li>
	</ul>
	<div id="program">
  ...
  <div id="view" style="height:20px; clear:both;"><p><span id="results_title" style="float:left">&nbsp;View Artifacts</span><img class="point-cursor" style="float:left; margin: 2px 2px 2px 2px;" src="expand.png" id="collection_title" name="collection_table" onclick="toggleRows(this.id, this.name);"/><span id="results_count" style="float:left; padding: 0px 0px 0px 40px;"></span></p></div>
...
def filter_script(): 
  ...
  function toggleRows(arrow_id, table_name){
  
	console.log($("#" + table_name).closest("tr")); //.nextUntil(".closed_rows")); //.toggleClass("closed_rows");
	
	if ($("#" + arrow_id).attr("src") ==  "expand.png")
		$("#" + arrow_id).attr("src", "collapse.png");
	else
		$("#" + arrow_id).attr("src", "expand.png");
  }
