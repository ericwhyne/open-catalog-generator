...
#<div id=''><p>The table on this page lists the programs currently participating in the catalog.</p>
  splash += """<div id='splash_desc'><p>The table below lists the programs currently participating in the catalog. The graph to the right displays the latest changes to the program data.</p>
